...
const CardContainer = () => {
  return (
    <div className="grid grid-cols-4 gap-x-6">
      <Card title="Documents" links= '/documents' value="115" percentage={100} />
      <Card title="Reconcilation" links= '/documents' value="30" percentage={50} />
      <Card title="Reports" links= '/documents' value="57" percentage={50} />
    </div>
  );
};
