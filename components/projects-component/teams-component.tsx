...
export default function Example() {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 border rounded-lg">
  ...
  <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
    <button
      type="button"
      className="block rounded-md border px-3 py-1.5 text-center text-sm font-semibold leading-6 text-gray-400 shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
    >
      Filters
    </button>
  </div>
                ...
                <tbody className="divide-y-0 divide-gray-200 bg-white">
                  {people.map((person) => (
                    ...
                    >
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500 items-center justify-center flex">
                      ...
                      <td className="whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-3">
                        <div className="border text-center items-center p-1 rounded flex items-center justify-center">
                          <a
                            href="#"
