...
const Card = ({ title, value, percentage, links }: CardProps) => {
  return (
    <Link
      className="my-4 bg-white overflow-hidden border shadow shadow-slate-100 cursor-pointer rounded-lg px-4 py-4 hover:shadow-xl hover:shadow-slate-100 transition-shadow duration-300"
      href={links}
    >
