...
export default function Signup() {
  ...
  const [btn, setBtn] = useState({ text: "Create an account", sending: false });
        ...
        <div className="w-3/6 bg-gray-50 h-screen">
          ...
          <div className=" bg-gray-50 flex flex-col justify-center items-center ">
            ...
            <div className="flex items-start text-left">
              {" "}
              <h3 className="font-bold text-2xl py-8 bg-gray-50 text-left">
            ...
            <ul className="mb-8 space-y-4 text-left text-gray-500 dark:text-gray-400 bg-gray-50">
              <li className="flex items-center space-x-3 bg-gray-50">
                <svg
                  className="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400 bg-gray-50"
                  fill="currentColor"
                  viewBox="0 0 20 20"
              ...
              <li className="flex items-center space-x-3 bg-gray-50">
                <svg
                  className="bg-gray-50 flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                >
        ...
        <div className="w-3/6 items-center justify-center">
          <div className="justify-center items-center ">
            ...
            <form onSubmit={handleSubmit} className="w-2/4 m-auto grid gap-4">
              <div className="flex justify-between">
                ...
                <div className="grid gap-y-2">
                  ...
                  <input
                    ...
                    name="email"
                    onChange={(e) => setEmail(e.target.value)}
                    className="bg-white border border-slate-300 text-slate-900 rounded-lg focus:outline-none focus:border-blue-400 px-2.5 w-fit focus-within:outline-none"
              ...
              <div className="grid md:flex items-center flex gap-y-4 gap-x-5 pb-3">
